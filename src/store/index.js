...
export default new Vuex.Store({
  state: {
    // currentWarehouse: "Warehouse-123",
    allWarehouse: [
      {
        name: "Warehouse-165",
        code: "W-00001",
  ...
  mutations: {
    //synchronous
    setAllWarehouse(state, payload) {
      // state.allWarehouse = payload;
      state.allWarehouse.push(payload);
    }
  },
  actions: {
    //asynchronous
  ...
  modules: {},
  getters: {
    getAllWarehouse(state) {
      return state.allWarehouse;
    }
  }
});
